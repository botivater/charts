...
{{ include "discordbot.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "discordbot.selectorLabels" -}}
...
*/}}
{{- define "discordbot.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "discordbot.fullname" .) .Values.serviceAccount.name }}
{{- else }}
